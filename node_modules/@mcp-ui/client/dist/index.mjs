...
var Ge = (r, e, t) => e in r ? Ye(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var I = (r, e, t) => Ge(r, typeof e != "symbol" ? e + "" : e, t), ee = (r, e, t) => e.has(r) || de("Cannot " + t);
var E = (r, e, t) => (ee(r, e, "read from private field"), t ? t.call(r) : e.get(r)), S = (r, e, t) => e.has(r) ? de("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), B = (r, e, t, n) => (ee(r, e, "write to private field"), n ? n.call(r, t) : e.set(r, t), t), T = (r, e, t) => (ee(r, e, "access private method"), t);
import { jsx as b, Fragment as X, jsxs as se } from "react/jsx-runtime";
import Q, { useRef as W, useImperativeHandle as Ve, useMemo as G, useCallback as We, useEffect as j, useState as ge, useDebugValue as He, memo as qe } from "react";
function Be(r) {
  let e;
  try {
    e = new URL(r);
...
function $e(r, e) {
  ...
  if (r.mimeType === "text/uri-list") {
    ...
    const n = t.split(`
`).map((o) => o.trim()).filter((o) => o && !o.startsWith("#") && Be(o));
    if (n.length === 0)
      return {
    ...
    if (typeof r.blob == "string")
      try {
        ...
        return console.error("Error decoding base64 blob for HTML content:", t), {
...
const O = {
  ...
  const l = W(null);
  Ve(d == null ? void 0 : d.ref, () => l.current);
  const { error: f, iframeSrc: i, iframeRenderMode: p, htmlString: u } = G(
    () => $e(r, n),
    [r, n]
  ), c = G(() => {
    if (i && s) {
      const _ = new URL(i);
      return _.searchParams.set(Ze.WAIT_FOR_RENDER_DATA, "true"), _.toString();
    }
    return i;
  }, [i, s]), m = We(
    (_) => {
      var v;
      if (s) {
        const y = _.currentTarget.contentWindow, w = c ? new URL(c).origin : "*";
        Y(
          O.UI_LIFECYCLE_IFRAME_RENDER_DATA,
          y,
          w,
          void 0,
          {
      ...
      (v = d == null ? void 0 : d.onLoad) == null || v.call(d, _);
    },
    [s, c, d == null ? void 0 : d.onLoad]
  );
  if (j(() => {
    async function _(v) {
      const { source: y, origin: w, data: g } = v;
      if (l.current && y === l.current.contentWindow) {
        if ((g == null ? void 0 : g.type) === O.UI_LIFECYCLE_IFRAME_READY && s) {
          Y(
            O.UI_LIFECYCLE_IFRAME_RENDER_DATA,
            y,
            w,
        ...
        if ((g == null ? void 0 : g.type) === O.UI_SIZE_CHANGE) {
          const { width: L, height: P } = g.payload;
          if (o && l.current) {
            const je = (typeof o == "boolean" || o.height) && P, Fe = (typeof o == "boolean" || o.width) && L;
            je && (l.current.style.height = `${P}px`), Fe && (l.current.style.width = `${L}px`);
          }
          return;
        }
        const F = g;
        ...
        if (e) {
          const L = F.messageId;
          Y(O.UI_MESSAGE_RECEIVED, y, w, L);
          try {
            const P = await e(F);
            Y(O.UI_MESSAGE_RESPONSE, y, w, L, {
              response: P
            });
          } catch (P) {
            console.error("Error handling UI action result in HTMLResourceRenderer:", P), Y(O.UI_MESSAGE_RESPONSE, y, w, L, {
              error: P
            });
          }
        }
  ...
  }, [e]), f) return /* @__PURE__ */ b("p", { className: "text-red-500", children: f });
  const h = G(() => p === "srcDoc" ? ue(a ?? "", "allow-scripts") : ue(a ?? "", "allow-scripts allow-same-origin"), [a, p]);
  return p === "srcDoc" ? u == null ? f ? null : /* @__PURE__ */ b("p", { className: "text-orange-500", children: "No HTML content to display." }) : /* @__PURE__ */ b(
    "iframe",
    {
      srcDoc: u,
      sandbox: h,
  ...
  ) : p === "src" ? c == null ? f ? null : /* @__PURE__ */ b("p", { className: "text-orange-500", children: "No URL provided for HTML resource." }) : /* @__PURE__ */ b(
    "iframe",
    {
      src: c,
      sandbox: h,
  ...
  ) : /* @__PURE__ */ b("p", { className: "text-gray-500", children: "Initializing HTML resource display..." });
};
re.displayName = "HTMLResourceRenderer";
...
const Re = 1, we = 3, Se = 8, Je = 9, Xe = 0, Qe = 1, et = 2, tt = 3, H = 1, ae = 2, le = 3, V = "~";
function Me({
  call: r,
  insertChild: e,
  removeChild: t,
...
class rt {
  constructor({
     ...
     */
    I(this, "attached", /* @__PURE__ */ new Map([[V, this.root]]));
    I(this, "subscribers", /* @__PURE__ */ new Map());
    I(this, "parents", /* @__PURE__ */ new Map());
    I(this, "implementations", /* @__PURE__ */ new Map());
    const {
      attached: s,
      parents: o,
      subscribers: a
    ...
    this.connection = Me({
      call: (i, p, ...u) => {
        const c = this.implementations.get(i), m = c == null ? void 0 : c[p];
        if (typeof m != "function")
          throw new Error(`Node ${i} does not implement the ${p}() method`);
        return m(...u);
      },
      insertChild: (i, p, u) => {
        const c = s.get(i), {
        ...
        u === m.length ? m.push(h) : m.splice(u, 0, h), c.version += 1, this.parents.set(p.id, c.id), d(c);
      },
      removeChild: (i, p) => {
        const u = s.get(i), {
          children: c
        } = u, [m] = c.splice(p, 1);
        m && (u.version += 1, d(u), f(m));
      },
      updateProperty: (i, p, u, c = H) => {
        const m = s.get(i);
        e == null || e(u);
        let h;
        switch (c) {
        ...
        let v;
        if (p === "slot") {
          const y = this.parents.get(i);
          v = y == null ? y : s.get(y), v && (v.version += 1);
        }
        d(m), v && d(v), t == null || t(_);
      },
      updateText: (i, p) => {
        const u = s.get(i);
        u.data = p, u.version += 1, d(u);
      }
    ...
    function l(i, p) {
      ...
      return s.set(u.id, u), o.set(u.id, p.id), u;
    }
    function f(i) {
...
const pe = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap();
class nt {
  constructor({
    root: e,
    retain: t,
     ...
     * (usually, a top-level browser page).
     */
    I(this, "attached", /* @__PURE__ */ new Map());
    ...
    this.connection = Me({
      call: (i, p, ...u) => {
        const c = i === V && this.root.nodeType !== 11 ? this.root : a.get(i);
        return s ? s(c, p, ...u) : c[p](...u);
      },
      insertChild: (i, p, u) => {
        const c = i === V ? this.root : a.get(i), m = d.get(i);
        m && clearTimeout(m), c.insertBefore(l(p), c.childNodes[u] || null);
      },
      removeChild: (i, p) => {
        const c = (i === V ? this.root : a.get(i)).childNodes[p];
    ...
    function l(i) {
      ...
      switch (i.type) {
        case Re: {
          if (u = document.createElement(i.element), i.properties) {
            $.set(u, i.properties);
            for (const c of Object.keys(i.properties)) {
              const m = i.properties[c];
              t == null || t(m), K(u, c, m, H);
            }
          } else
            $.set(u, {});
          if (i.attributes)
            for (const c of Object.keys(i.attributes)) {
              const m = i.attributes[c];
              t == null || t(m), K(u, c, m, ae);
            }
          if (Ne.set(u, {}), i.eventListeners)
            for (const c of Object.keys(i.eventListeners)) {
              const m = i.eventListeners[c];
              t == null || t(m), K(u, c, m, le);
            }
        ...
        case we: {
          u = document.createTextNode(i.data);
          break;
        }
        case Se: {
          u = document.createComment(i.data);
          break;
        }
        default:
          throw new Error(`Unknown node type: ${JSON.stringify(i)}`);
      }
      return pe.set(u, i.id), a.set(i.id, u), u;
    }
    function f(i) {
      const p = pe.get(i);
      p && a.delete(p);
      const u = $.get(i);
      if (u && n && n(u), i instanceof Element)
...
function K(r, e, t, n) {
  switch (n) {
    ...
    case le: {
      const s = Ne.get(r), o = s == null ? void 0 : s[e];
      if (o && r.removeEventListener(e, o), t != null) {
        const a = (d) => {
          var f;
          if (d.target !== r) return;
          const l = t(d.detail);
          (f = d.resolve) == null || f.call(d, l);
        };
  ...
  return He(s), j(() => {
    const o = new AbortController(), a = () => {
      o.signal.aborted || n((d) => {
        ...
        if (i !== e || l !== p)
          return d;
        const u = e.get(r), c = u == null ? void 0 : u.version;
        return f === c ? d : {
          receiver: e,
          value: u,
          id: p,
...
function it(r, e) {
  ...
  if (e.eventProps)
    ...
    for (const [l, f] of Object.entries(o))
      d[`on${l[0].toUpperCase()}${l.slice(1)}`] = me(f);
  for (const l of t)
    if (l.type === 1 && typeof l.attributes.slot == "string") {
      const f = l.attributes.slot, i = ne(l, e);
      d[f] = d[f] ? /* @__PURE__ */ se(X, {
        children: [d[f], i]
      }) : i;
    } else
      a.push(ne(l, e));
...
const st = Symbol.for("remote-dom.element"), at = Symbol.for("remote-dom.element.attached");
function lt(r, {
  name: e,
  eventProps: t
} = {}) {
  const n = /* @__PURE__ */ qe(function({
    element: o,
    receiver: a,
    components: d
  }) {
    const l = W(), f = ce(o, a), i = f ?? o, p = i.id, u = it(i, {
      receiver: a,
      components: d,
      eventProps: t
    });
    if (u[st] = i, u[at] = f != null, l.current == null) {
      const c = {
        id: p,
        receiver: a
      };
      c.instanceRef = ct(c), l.current = c;
    }
    return l.current.id = p, l.current.receiver = a, j(() => {
      var m;
      const c = {
        id: p
      };
      return a.implement(c, (m = l.current) == null ? void 0 : m.instanceRef.current), () => {
        a.implement(c, null);
      };
    }, [p, a]), /* @__PURE__ */ b(r, {
...
function dt(r) {
  ...
  return /* @__PURE__ */ b(X, {
    children: t.map((n) => ne(n, r))
  });
}
const ut = `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
</head>
...
</html>`, fe = 1, he = 2, Ae = 3, _e = 4, Pe = 5, Ee = Symbol.for("quilt.threads.serialize"), pt = Symbol.for("quilt.threads.transferable");
class mt extends AbortController {
  constructor(...e) {
    super();
...
let ft = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
function Ie(r = 21) {
  let e = "", t = crypto.getRandomValues(new Uint8Array(r));
  for (let n = 0; n < r; n++) e += ft[63 & t[n]];
  return e;
}
var z, C, U, q, J, Oe;
class ht {
  constructor() {
    ...
    S(this, C, /* @__PURE__ */ new Map());
    S(this, U, /* @__PURE__ */ new Map());
    S(this, q, /* @__PURE__ */ new WeakMap());
  }
  get(e) {
    return E(this, C).get(e);
  }
  release(e) {
    const t = E(this, C).get(e);
    return t && (E(this, C).delete(e), E(this, z).delete(t)), !!t;
  }
  serialize(e) {
    let t = E(this, z).get(e);
    return t == null && (t = Ie(), E(this, z).set(e, t), E(this, C).set(t, e)), t;
  }
  deserialize(e, t) {
    var s, o;
    let n = (s = E(this, U).get(e)) == null ? void 0 : s.deref();
    return n || (n = (...a) => {
      if (!E(this, U).has(e))
        throw new Error("You attempted to call a function that was already revoked.");
      return t.call((d, l, f) => {
        t.messages.send([Ae, d, e, l], f);
      }, a);
    }, (o = T(this, J, Oe).call(this, t)) == null || o.register(n, e), E(this, U).set(e, new WeakRef(n)), n);
  }
}
z = new WeakMap(), C = new WeakMap(), U = new WeakMap(), q = new WeakMap(), J = new WeakSet(), Oe = function(e) {
  let t = E(this, q).get(e);
  if (!(typeof FinalizationRegistry > "u"))
    return t || (t = new FinalizationRegistry((n) => {
      e.messages.send([Pe, n]);
    }), E(this, q).set(e, t)), t;
};
function _t(r) {
...
class Et {
  constructor(e) {
    ...
    S(this, x);
    S(this, k);
    B(this, x, e == null ? void 0 : e.serialize), B(this, k, e == null ? void 0 : e.deserialize);
  }
  /**
   * Serializes a value into a structured cloning-compatible format that can be transferred between threads.
   */
  serialize(e, t, n) {
    return T(this, R, Z).call(this, e, t, n);
  }
  /**
   * Deserializes a structured cloning-compatible value from another thread.
   */
  deserialize(e, t) {
    return T(this, R, N).call(this, e, t);
  }
}
x = new WeakMap(), k = new WeakMap(), R = new WeakSet(), Z = function(e, t, n, s = /* @__PURE__ */ new Map(), o = !1) {
  if (e == null) return e;
  if (s.has(e)) return s.get(e);
  if (s.set(e, void 0), typeof e == "object") {
    if (E(this, x) && !o) {
      const l = E(this, x).call(this, e, (f) => T(this, R, Z).call(this, f, t, n, s, !0), t, n);
      if (l !== void 0)
        return s.set(e, l), l;
    }
    if (e[pt])
      return n == null || n.push(e), s.set(e, e), e;
    const a = (l) => T(this, R, Z).call(this, l, t, n, s);
    ...
    if (e instanceof Map) {
      const l = [...e.entries()].map(([i, p]) => [a(i), a(p)]), f = new Map(l);
      return s.set(e, f), f;
    }
    if (e instanceof Set) {
    ...
    if (ve(e) || d) {
      ...
      for (const f of Object.keys(e))
        l[f] = a(e[f]);
      return d && (l.next ?? (l.next = a(e.next.bind(e))), l.return ?? (l.return = a(e.return.bind(e))), l.throw ?? (l.throw = a(e.throw.bind(e))), l[ye] = !0), s.set(e, l), l;
    }
  }
  if (typeof e == "function") {
    const a = t.functions.serialize(e, t, n), d = {
      [te]: a
    };
    return s.set(e, d), d;
  }
  ...
  if (typeof e == "object") {
    if (E(this, k) && !n) {
      const o = E(this, k).call(this, e, (a) => T(this, R, N).call(this, a, t, !0), t);
      if (o !== void 0)
        return o;
    }
    if (e == null)
      return e;
    if (Array.isArray(e))
      return e.map((o) => T(this, R, N).call(this, o, t));
    if (e instanceof Map)
      return new Map([...e].map(([o, a]) => [T(this, R, N).call(this, o, t), T(this, R, N).call(this, a, t)]));
    if (e instanceof Set)
      return new Set([...e].map((o) => T(this, R, N).call(this, o, t)));
    if (te in e)
      return t.functions.deserialize(e[te], t);
    if (!ve(e))
      return e;
    const s = {};
    for (const o of Object.keys(e))
      o === ye ? s[Symbol.asyncIterator] = () => s : s[o] = T(this, R, N).call(this, e[o], t);
    return s;
  }
  return e;
};
var D, A, M, oe, Ce, ie, De;
class bt {
  constructor(e, {
    imports: t,
    exports: n,
    functions: s = new ht(),
    serialization: o = new Et(),
    signal: a
  } = {}) {
    S(this, M);
    S(this, D);
    S(this, A, /* @__PURE__ */ new Map());
    var d, l, f, i;
    this.messages = e, B(this, D, a ? new mt(a) : new AbortController()), this.exports = n ?? {}, this.imports = vt(T(this, M, Ce).bind(this), t), this.functions = s, this.serialization = o, (l = (d = this.functions).start) == null || l.call(d, this), (i = (f = this.serialization).start) == null || i.call(f, this), this.signal.addEventListener("abort", () => {
      for (const p of E(this, A).keys())
        T(this, M, ie).call(this, p, void 0, new be());
      E(this, A).clear();
    }, {
      once: !0
    }), e.listen(async (p) => {
      ...
      switch (c[0]) {
        case fe: {
          const [, m, h, _] = c, v = this.exports[h] ?? (() => {
            throw new Error(`No '${h}' method is exported from this thread`);
          });
          await T(this, M, oe).call(this, v, _, (y, w, g) => {
            this.messages.send([he, m, y, w], g);
          });
          break;
        }
        case Ae: {
          const [, m, h, _] = c, v = this.functions.get(h, this) ?? yt;
          await T(this, M, oe).call(this, v, _, (y, w, g) => {
            this.messages.send([_e, m, y, w], g);
          });
          break;
        }
        case he:
        case _e: {
          T(this, M, ie).call(this, ...c.slice(1));
          break;
        }
        case Pe: {
          const m = c[1];
   ...
   */
  get signal() {
    return E(this, D).signal;
  }
  /**
   * A boolean indicating whether the communication channel is still open.
   */
  get closed() {
    return E(this, D).signal.aborted;
  }
  /**
   * Closes the communication channel between the two threads. This will prevent
   * any further communication between the threads, and will clean up any memory
  ...
  call(e, t) {
    ...
    const n = [], s = this.serialization.serialize(t, this, n), o = Ie(), a = T(this, M, De).call(this, o);
    return e(o, s, n), a;
  }
}
D = new WeakMap(), A = new WeakMap(), M = new WeakSet(), oe = async function(e, t, n) {
  try {
  ...
  const t = e[0], n = E(this, A).get(t);
  n && (n(...e), E(this, A).delete(t));
}, De = function(e) {
  const t = new Promise((n, s) => {
    E(this, A).set(e, (o, a, d) => {
      d == null ? n(this.serialization.deserialize(a, this)) : s(this.serialization.deserialize(d, this));
    });
  });
...
const Tt = "quilt.threads.ping", Te = "quilt.threads.pong";
function gt(r, {
  targetOrigin: e = "*"
} = {}) {
  let t = !1;
  const n = function(a, d) {
    r.postMessage(a, e, d);
  }, s = new Promise((o) => {
    const a = new AbortController();
    globalThis.window.addEventListener("message", (d) => {
      d.source === r && d.data === Te && (t = !0, a.abort(), o());
    }, {
      signal: a.signal
...
class Rt extends bt {
  constructor(e, {
    ...
    super(gt(e.contentWindow, {
      targetOrigin: t
    }), n), this.iframe = e;
  }
}
const Le = Q.forwardRef(({ content: r, children: e, ...t }, n) => /* @__PURE__ */ b("span", { ref: n, ...t, children: r || e }));
Le.displayName = "UIText";
const ze = Q.forwardRef(({ label: r, onPress: e, onClick: t, children: n, ...s }, o) => /* @__PURE__ */ b(
  "button",
  {
    ref: o,
    onClick: (d) => {
...
Ue.displayName = "UIStack";
const xe = Q.forwardRef(({ src: r, alt: e, width: t, height: n, children: s, ...o }, a) => /* @__PURE__ */ b(
  "img",
  {
    ref: a,
    src: r,
...
const ke = {
  ...
  }, [r]), /* @__PURE__ */ b("div", { ref: e, "data-testid": "standard-dom-renderer-container" });
}, St = ({
  resource: r,
  library: e,
  remoteElements: t = [],
  ...
  const s = W(null), o = W(null), [a, d] = ge(null), l = G(() => (r.mimeType || "").includes("framework=react") ? "react" : "webcomponents", [r.mimeType]), f = `${e == null ? void 0 : e.name}-${l}`, { receiver: i, components: p } = G(() => {
    switch (l) {
      case "react": {
        const c = new rt(), m = e || ke, h = /* @__PURE__ */ new Map();
        return m && m.elements.forEach((_) => {
          const v = lt(_.component);
          h.set(_.tagName, v);
        }), {
          receiver: c,
          components: h
  ...
  j(() => {
    function c(m) {
      var h;
      if (s.current && m.source === s.current.contentWindow) {
        const _ = m.data;
        if (!_)
          return;
        (h = n == null ? void 0 : n(_)) == null || h.catch((v) => {
          console.error("Error handling UI action result in RemoteDOMResourceRenderer:", v);
        });
      }
    }
  ...
  const u = () => {
    ...
    if (h && (i != null && i.connection)) {
      ...
      m.imports.render(v, i.connection).catch((y) => console.error("Error calling remote render:", y));
    }
  };
  return a ? /* @__PURE__ */ b("p", { className: "text-red-500", children: a }) : /* @__PURE__ */ se(X, { children: [
    /* @__PURE__ */ b(
      "iframe",
      {
        ref: s,
    ...
    l === "react" && p ? /* @__PURE__ */ b(dt, { receiver: i, components: p }) : /* @__PURE__ */ b(wt, { receiver: i })
  ] });
};
function Mt(r) {
  var e;
...
const Nt = (r) => {
  const { resource: e, onUIAction: t, supportedContentTypes: n, htmlProps: s, remoteDomProps: o } = r, a = Mt(e);
  if (n && a && !n.includes(a))
    return /* @__PURE__ */ se("p", { className: "text-red-500", children: [
  ...
  switch (a) {
    case "rawHtml": {
      const { proxy: d, ...l } = s || {};
      return /* @__PURE__ */ b(re, { resource: e, onUIAction: t, ...l });
    }
    case "externalUrl":
      return /* @__PURE__ */ b(re, { resource: e, onUIAction: t, ...s });
    case "remoteDom":
      return /* @__PURE__ */ b(
        St,
        {
          resource: e,
          onUIAction: t,
          library: (o == null ? void 0 : o.library) || ke,
          ...o
        }
      );
    default:
      return /* @__PURE__ */ b("p", { className: "text-red-500", children: "Unsupported resource type." });
  }
};
Nt.displayName = "UIResourceRenderer";
const Ot = {
  tagName: "ui-card"
}, Ct = {
  tagName: "ui-button",
...
export {
  Nt as UIResourceRenderer,
  ke as basicComponentLibrary,
  Ct as remoteButtonDefinition,
  Ot as remoteCardDefinition,
  zt as remoteImageDefinition,
  Lt as remoteStackDefinition,
  Dt as remoteTextDefinition
};
