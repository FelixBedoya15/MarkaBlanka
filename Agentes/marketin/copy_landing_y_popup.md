...
## 🛑 TEXTO DEL POP-UP (Aparece a los 5 minutos del video)
...
👤 Tu nombre (Ej: Carlos Pérez)  
📧 Tu mejor correo (Asegúrate que esté bien escrito)  
📱 Tu número de WhatsApp (Opcional, para enviarte el link)

**[BOTÓN PRINCIPAL - Color Verde/Teal]**  
▶️ ENVIAR DATOS Y CONTINUAR LA CLASE

*(Nota de UX: Una vez el usuario hace clic, el pop-up desaparece y el video continúa automáticamente desde donde quedó).*

---

## 💻 TEXTOS DE LA LANDING PAGE

### 1. SECCIÓN SUPERIOR (Above the Fold - Antes de hacer scroll)

**[ANTETÍTULO - Arriba del todo, fondo oscuro, texto blanco]**  
⚠️ **ATENCIÓN:** Para Asesores y Profesionales de Seguridad y Salud en el Trabajo en Colombia

**[TÍTULO PRINCIPAL - Grande, llamativo]**  
**Cómo Hacer en 20 Minutos el Trabajo Documental de 3 Días y Duplicar el Valor de Tus Asesorías con Inteligencia Artificial**

**[SUBTÍTULO - Debajo del título]**  
La clase gratuita donde descubrirás el método de la *SST Bio-Individual* y la única plataforma de IA en Colombia diseñada para el Sistema de Gestión.

**[ÁREA DEL VIDEO]**  
*(Aquí va el reproductor de video con el VSL de 25 minutos. El video no debe tener controles de avance rápido para forzar la visualización hasta el código de descuento).*
...
👉 **[BOTÓN 1] PLAN MENSUAL ($80.223 / mes)**  
👉 **[BOTÓN 2 - DESTACADO] PLAN ANUAL ($842.160 / año) + Usa tu cupón aquí**  

*(Texto pequeño debajo de los botones)*  
🔒 Pago 100% seguro por Wompi | Acceso inmediato a la plataforma y al Aula de Estudio.

---

### 2. SECCIÓN DE BENEFICIOS (Debajo de los botones de pago)
...
✅ **Actualizaciones Normativas 2026:** La IA ya incluye los cambios en la jornada laboral y reformas, garantizando que tu trabajo siempre cumpla la ley.
...
**[BOTÓN FINAL]**  
▶️ **QUIERO ENTRAR AL PROGRAMA SOMOS SST AHORA**
