# Guion Video Largo (VSL) — Landing Page
**Autor:** Felix Bedoya | **Versión:** Mayo 2026  
**Duración estimada:** 20 - 25 minutos  
**Formato:** Video horizontal (16:9) para página web. Félix Bedoya hablando a cámara, intercalado con grabaciones de pantalla de la plataforma.

---

## 📌 NOTAS DE PRODUCCIÓN Y ESTRUCTURA DEL EMBUDO

Este video es el corazón de tu estrategia. Está diseñado bajo el modelo de "Clase de Valor + Venta Invisible".
...
## 🎬 GUION COMPLETO (VIDEO SALES LETTER)

### PARTE 1: EL GANCHO Y LA PROMESA (0:00 - 1:30)
*(Félix sentado en un ambiente profesional, relajado pero seguro. Hablando directo a la cámara).*

**Félix:**
"Hola, soy Félix Bedoya. Y quiero hacerte una pregunta que probablemente ningún otro experto en Seguridad y Salud en el Trabajo te ha hecho:

¿Por qué dos trabajadores, con la misma edad, el mismo cargo, haciendo la misma tarea bajo las mismas condiciones... uno se accidenta o se enferma, y el otro no?

Piénsalo un segundo. Toda la vida nos han enseñado a hacer matrices de peligros, a evaluar riesgos y a crear políticas pensando en un 'trabajador promedio'. Nos enseñaron a proteger el entorno, a poner barandas y entregar guantes. Pero el entorno es solo el catalizador. El riesgo real se materializa en la fisiología de cada persona. 

Si sigues haciendo Seguridad y Salud en el Trabajo para 'el promedio', estás trabajando en el pasado. Y lo peor... te están pagando como alguien del pasado.

En los próximos minutos, te voy a mostrar cómo el mercado de SST acaba de cambiar para siempre gracias a la Inteligencia Artificial. Te voy a enseñar qué es la SST Bio-Individual. Y, lo más importante, te voy a mostrar en vivo la herramienta que construí para que tú puedas hacer en 20 minutos el trabajo que hoy te toma 3 días... y puedas cobrar el doble por ello."

### PARTE 2: AUTORIDAD Y EL PROBLEMA REAL (1:30 - 5:00)
*(Félix puede intercalar con gráficos de apoyo en pantalla).*

**Félix:**
"Si eres asesor independiente o trabajas dentro de una empresa, seguro has sentido esto: pasas días enteros peleando con celdas de Excel para terminar una Matriz GTC-45. Te desgastas copiando y pegando leyes para actualizar un Reglamento Interno de Trabajo. Entregas carpetas enormes que nadie lee, y al final, el gerente de la empresa siente que el SG-SST es solo un gasto obligatorio, no una inversión.

Como resultado: a los asesores les piden rebajas y cotizan barato para ganar clientes. Y a los profesionales de planta, en las empresas, les niegan el reconocimiento, se quedan estancados y no les dan los ascensos ni los bonos que merecen por todo su esfuerzo.

¿Por qué? Porque **la oferta de valor se estancó**. 
...
Sé que suena a ciencia ficción. Por eso no quiero que me creas. Quiero que lo veas con tus propios ojos."

---

### 🛑 PARTE 3: EL POP-UP (Minuto 5:00)
*(Félix hace una pausa estratégica)*
...
*(Se muestra cómo la IA empieza a generar las filas completas de la GTC-45).*

En segundos, el agente me genera los procesos, las tareas, identifica los peligros biomecánicos, físicos, de seguridad, me calcula el nivel de deficiencia, de exposición, la probabilidad, y me sugiere los controles exactos en la fuente, medio y trabajador. Todo esto lo paso a mi tabla y lo exporto a Excel o PDF profesional en un clic. Lo que te tomaba 2 días, acaba de tomar 5 minutos.

Pero vamos más allá. Mira el módulo **Somos SST**. Esta es la joya de la corona. Aquí aplicamos la *SST Bio-Individual*. Desde aquí, los trabajadores de la empresa pueden llenar su perfil sociodemográfico desde su celular. La IA recolecta esa data y la cruza con las condiciones de salud y los peligros. 

Y mira lo que pasa en el **Dashboard Predictivo**. La IA me dice: *'Félix, tienes una alerta. Este grupo de trabajadores en bodega tiene una probabilidad del 85% de desarrollar una lesión lumbar en los próximos 6 meses por la combinación de su peso, su edad y sus rutinas de levantamiento'.* 
...
### PARTE 5: LA OFERTA Y LA TRANSFORMACIÓN (15:00 - 20:00)
...
Opción 1: Seguir haciendo todo manualmente. Seguir cobrando lo mismo por asesorías que te toman semanas. Seguir esperando un ascenso que no llega porque tu trabajo no se percibe como estratégico. Y ver cómo otros profesionales, que sí usan IA, te empiezan a quitar clientes o posiciones porque son 10 veces más rápidos y precisos que tú.

Opción 2: Dar el salto hoy mismo. 
...
Todo esto está dentro de la misma plataforma. Entras, estudias en el Aula, y aplicas en el módulo de al lado."

---

### PARTE 6: EL PRECIO Y EL CÓDIGO (20:00 - Cierre)
*(Aparecen gráficos de precios en pantalla).*
...
Pero ojo, **este código y esta oferta son válidos solo por 48 horas**. Mi objetivo es trabajar con la primera ola de profesionales que van a liderar la nueva era de la SST en Colombia.

Haz clic en el botón debajo de este video. Selecciona tu plan. Ingresa tu código. Y empieza a transformar tu carrera profesional ahora mismo.

El mercado ya cambió. La pregunta es: ¿vas a liderar el cambio o vas a dejar que te reemplace el que sí lo hizo?
