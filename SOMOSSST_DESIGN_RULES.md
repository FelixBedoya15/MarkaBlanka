# 🎨 Reglas de Diseño de SomosSST (SomosSST_DESIGN_RULES)

Este documento contiene las normativas estrictas de diseño, paleta de colores y componentes visuales experimentadas en la plataforma de **SomosSST**. Su propósito es servir como la "Biblia visual" para cualquier Agente de Inteligencia Artificial o Desarrollador que vaya a crear o refactorizar páginas, modales o secciones completas.
...
SomosSST detesta los fondos vacíos. Por ende, los paneles de actualización, o el fondo de una vista importante, siempre debe tener "reflejos/brillos" borrosos como luces en las esquinas posteriores:
...
## 📌 Checklist al Diseñar o Alterar un Componente en SomosSST:
