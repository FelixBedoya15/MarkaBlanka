    ...
    var Anser = function() {
      ...
      _createClass(Anser2, [{
        ...
        value: function setupPalette() {
          ...
          var format = function format2(r3, g2, b2) {
            return levels[r3] + ", " + levels[g2] + ", " + levels[b2];
          };
          var r2 = void 0, g = void 0, b = void 0;
            ...
            if (isNaN(num) || num === 0) {
              ...
              if (nums.length >= 1) {
                ...
                if (mode === "5" && nums.length >= 1) {
                  ...
                  if (r2 >= 0 && r2 <= 255 && g >= 0 && g <= 255 && b >= 0 && b <= 255) {
                    var color = r2 + ", " + g + ", " + b;
                    if (!use_classes) {
                      if (is_foreground) {
                        self.fg = color;
    ...
    return __generator(this, function(_c) {
      switch (_c.label) {
        case 0:
          ...
          return [3, 5];
        case 1:
          return [4, import("./node-MQR2M2JR.js").then(function(m) {
        ...
        case 2:
          ...
          return [3, 7];
        case 3:
          return [4, import("./index-599aeaf7-3AZZFNVY.js").then(function(m) {
        ...
        case 4:
          ...
          return [3, 7];
        case 5:
          return [4, import("./runtime-D44AGZGR.js").then(function(m) {
...
function getWhitespaceDeco(space3) {
  let deco = WhitespaceDeco.get(space3);
  if (!deco)
    WhitespaceDeco.set(space3, deco = Decoration.mark({
      attributes: space3 === "	" ? {
        class: "cm-highlightTab"
      } : {
        class: "cm-highlightSpace",
        "data-display": space3.replace(/ /g, "·")
      }
    }));
  return deco;
}
...
var alwaysIsolate = Facet.define({ combine: (values2) => values2.some((x) => x) });
...
].concat(eventAttributes.map((name2) => ({ name: name2, parser: javascriptLanguage.parser })));
...
function r(r2) {
  var t2 = r2 && r2.pop ? [] : {};
  for (var n in r2) t2[n] = r2[n];
  return t2;
}
function clean_set_es_default(t2, n, l) {
  n.split && (n = n.split("."));
  for (var o = r(t2), a = o, e = 0, f = n.length; e < f; e++) a = a[n[e]] = e === f - 1 ? l && l.call ? l(a[n[e]]) : l : r(a[n[e]]);
  return o;
}
...
export {
  ...
  indentLess,
  defaultKeymap,
  module_default2 as module_default,
  css,
  javascript,
  html,
  require_lib,
...
//# sourceMappingURL=chunk-HRDP2A4G.js.map
