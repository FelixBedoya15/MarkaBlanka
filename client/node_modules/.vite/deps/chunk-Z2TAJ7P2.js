...
import {
  ...
  useUpdateEffect,
  useWrapElement
} from "./chunk-IE6U6JPM.js";
import {
  require_react_dom
} from "./chunk-YT4CS73W.js";
import {
  require_jsx_runtime
...
var useCollectionItem = createHook(
  function useCollectionItem2(_a) {
    ...
    store = store || context;
    const id = useId(props.id);
    const ref = (0, import_react2.useRef)(element);
...
var FocusableContext = (0, import_react3.createContext)(true);
...
var useFocusable = createHook(
  function useFocusable2(_a) {
    ...
    const [focusVisible, setFocusVisible] = (0, import_react4.useState)(false);
    (0, import_react4.useEffect)(() => {
      if (!focusable) return;
    ...
    const autoFocusOnShow = (0, import_react4.useContext)(FocusableContext);
...
var useCommand = createHook(
  function useCommand2(_a) {
    ...
    const [isNativeButton, setIsNativeButton] = (0, import_react5.useState)(false);
...
var useCompositeItem = createHook(
  function useCompositeItem2(_a) {
    ...
    const row = (0, import_react6.useContext)(CompositeRowContext);
    const disabled = disabledFromProps(props);
    ...
    const getItem = (0, import_react6.useCallback)(
      (item) => {
        var _a2;
    ...
    const hasFocusedComposite = (0, import_react6.useRef)(false);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime.jsx)(CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = __spreadProps(__spreadValues({
      id,
...
var useDisclosureContent = createHook(function useDisclosureContent2(_a) {
  ...
  const id = useId(props.id);
  const [transition, setTransition] = (0, import_react8.useState)(null);
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime3.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var DisclosureContent = forwardRef2(function DisclosureContent2(_a) {
  ...
  return (0, import_jsx_runtime3.jsx)(DisclosureContentImpl, __spreadValues({}, props));
});
...
var PortalContext = (0, import_react9.createContext)(null);
...
var usePortal = createHook(function usePortal2(_a) {
  ...
  const context = (0, import_react10.useContext)(PortalContext);
  const [portalNode, setPortalNode] = (0, import_react10.useState)(null);
  const [anchorPortalNode, setAnchorPortalNode] = (0, import_react10.useState)(
    null
  );
  const outerBeforeRef = (0, import_react10.useRef)(null);
  const innerBeforeRef = (0, import_react10.useRef)(null);
  const innerAfterRef = (0, import_react10.useRef)(null);
  const outerAfterRef = (0, import_react10.useRef)(null);
  useSafeLayoutEffect(() => {
    const element = ref.current;
    if (!element || !portal) {
      setPortalNode(null);
  ...
  props = useWrapElement(
    ...
    (element) => {
      ...
      (0, import_jsx_runtime4.jsx)(PortalContext.Provider, { value: portalNode || context, children: element });
      ...
      element = (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime4.jsx)(
          FocusTrap,
          {
            ref: innerBeforeRef,
      ...
      let preserveTabOrderElement = (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime4.jsx)(
          FocusTrap,
          {
            ref: outerBeforeRef,
        ...
        (0, import_jsx_runtime4.jsx)("span", { "aria-owns": portalNode == null ? void 0 : portalNode.id, style: { position: "fixed" } }),
        preserveTabOrder && portalNode && (0, import_jsx_runtime4.jsx)(
          FocusTrap,
          {
            ref: outerAfterRef,
...
var HeadingContext = (0, import_react11.createContext)(0);

// ../node_modules/@ariakit/react-core/esm/__chunks/5M6RIVE2.js
var import_react12 = __toESM(require_react(), 1);
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
function HeadingLevel({ level, children }) {
  const contextLevel = (0, import_react12.useContext)(HeadingContext);
  const nextLevel = Math.max(
    Math.min(level || contextLevel + 1, 6),
    1
  );
  return (0, import_jsx_runtime5.jsx)(HeadingContext.Provider, { value: nextLevel, children });
}
...
var Role = forwardRef2(
  ...
  function Role2(props) {
    return createElement(TagName12, props);
  }
);
Object.assign(
  Role,
...
var useFocusableContainer = createHook(function useFocusableContainer2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime6.jsx)(FocusableContext.Provider, { value: autoFocusOnShow, children: element }),
    [autoFocusOnShow]
  );
  return props;
});
...
function usePreviousMouseDownRef(enabled) {
  const previousMouseDownRef = (0, import_react13.useRef)();
...
function useEventOutside({
  ...
  const focusedRef = (0, import_react14.useRef)(false);
  useSafeLayoutEffect(() => {
    if (!open) return;
    if (!domReady) return;
...
var NestedDialogsContext = (0, import_react15.createContext)({});
function useNestedDialogs(store) {
  const context = (0, import_react15.useContext)(NestedDialogsContext);
  const [dialogs, setDialogs] = (0, import_react15.useState)([]);
  ...
  const providerValue = (0, import_react15.useMemo)(() => ({ store, add }), [store, add]);
  const wrapElement = (0, import_react15.useCallback)(
    (element) => (0, import_jsx_runtime7.jsx)(NestedDialogsContext.Provider, { value: providerValue, children: element }),
    [providerValue]
  );
...
function useRootDialog({
  ...
  const isRootDialog = (0, import_react16.useCallback)(() => {
...
function DialogBackdrop({
  ...
  if ((0, import_react18.isValidElement)(backdrop)) {
    return (0, import_jsx_runtime8.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: backdrop }));
  }
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return (0, import_jsx_runtime8.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: (0, import_jsx_runtime8.jsx)(Component, {}) }));
}
...
var useDialog = createHook(function useDialog2(_a) {
  ...
  const [autoFocusEnabled, setAutoFocusEnabled] = (0, import_react19.useState)(false);
  (0, import_react19.useEffect)(() => {
    if (!open) return;
  ...
  const focusOnHide = (0, import_react19.useCallback)(
    (dialog, retry = true) => {
      const { disclosureElement } = store.getState();
  ...
  const focusedOnHideRef = (0, import_react19.useRef)(false);
  useSafeLayoutEffect(() => {
    if (open) return;
    if (!hasOpened) return;
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime9.jsx)(HeadingLevel, { level: modal ? 1 : void 0, children: element }),
    [modal]
  );
  ...
  const [headingId, setHeadingId] = (0, import_react19.useState)();
  const [descriptionId, setDescriptionId] = (0, import_react19.useState)();
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime9.jsx)(DialogScopedContextProvider, { value: store, children: (0, import_jsx_runtime9.jsx)(DialogHeadingContext.Provider, { value: setHeadingId, children: (0, import_jsx_runtime9.jsx)(DialogDescriptionContext.Provider, { value: setDescriptionId, children: element }) }) }),
    [store]
  );
  props = __spreadProps(__spreadValues({
    id,
...
function createDialogComponent(Component, useProviderContext = useDialogProviderContext) {
  return forwardRef2(function DialogComponent(props) {
    ...
    return (0, import_jsx_runtime9.jsx)(Component, __spreadValues({}, props));
  });
}
...
var usePopover = createHook(
  function usePopover2(_a) {
    ...
    const defaultArrowElementRef = (0, import_react20.useRef)(null);
    const [positioned, setPositioned] = (0, import_react20.useState)(false);
    const { portalRef, domReady } = usePortalRef(portal, props.portalRef);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime10.jsx)(
        "div",
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime10.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = __spreadProps(__spreadValues({
  ...
  const children = (0, import_react21.useMemo)(
    () => (0, import_jsx_runtime11.jsx)(
      "svg",
      {
        ...
        height: "1em",
        width: "1em",
        children: (0, import_jsx_runtime11.jsx)("polyline", { points })
      }
    ),
    [points]
  );
...
var useButton = createHook(
  function useButton2(props) {
    ...
    const tagName = useTagName(ref, TagName18);
    const [isNativeButton, setIsNativeButton] = (0, import_react22.useState)(
...
var usePopoverDisclosure = createHook(function usePopoverDisclosure2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime12.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
    [store]
  );
  props = __spreadProps(__spreadValues({}, props), {
    onClick
    ...
    const children = (0, import_react24.useMemo)(
      () => (0, import_jsx_runtime13.jsxs)(
        "svg",
        {
          ...
          width: "1em",
          children: [
            (0, import_jsx_runtime13.jsx)("line", { x1: "4", y1: "4", x2: "12", y2: "12" }),
            (0, import_jsx_runtime13.jsx)("line", { x1: "4", y1: "12", x2: "12", y2: "4" })
          ]
        }
      ),
      []
...
var useHeading = createHook(
  function useHeading2(props) {
    ...
    const level = (0, import_react25.useContext)(HeadingContext) || 1;
    const Element = `h${level}`;
    const tagName = useTagName(ref, Element);
    const isNativeHeading = (0, import_react25.useMemo)(
...
var useDialogHeading = createHook(
  function useDialogHeading2(_a) {
    var _b = _a, { store } = _b, props = __objRest(_b, ["store"]);
    const setHeadingId = (0, import_react26.useContext)(DialogHeadingContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
var useCompositeTypeahead = createHook(function useCompositeTypeahead2(_a) {
  ...
  const onKeyDownCaptureProp = props.onKeyDownCapture;
  const cleanupTimeoutRef = (0, import_react27.useRef)(0);
  const onKeyDownCapture = useEvent((event) => {
    onKeyDownCaptureProp == null ? void 0 : onKeyDownCaptureProp(event);
    if (event.defaultPrevented) return;
    if (!typeahead) return;
...
var GroupLabelContext = (0, import_react28.createContext)(void 0);
...
var useGroupLabel = createHook(
  function useGroupLabel2(props) {
    const setLabelId = (0, import_react29.useContext)(GroupLabelContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
var useGroup = createHook(
  function useGroup2(props) {
    const [labelId, setLabelId] = (0, import_react30.useState)();
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime15.jsx)(GroupLabelContext.Provider, { value: setLabelId, children: element }),
      []
    );
    props = __spreadValues({
      role: "group",
...
var CheckboxCheckedContext = (0, import_react31.createContext)(false);

// ../node_modules/@ariakit/react-core/esm/__chunks/5JCRYSSV.js
var import_react32 = __toESM(require_react(), 1);
var import_jsx_runtime16 = __toESM(require_jsx_runtime(), 1);
var TagName32 = "span";
var checkmark = (0, import_jsx_runtime16.jsx)(
  "svg",
  {
    display: "block",
    fill: "none",
    ...
    height: "1em",
    width: "1em",
    children: (0, import_jsx_runtime16.jsx)("polyline", { points: "4,8 7,12 12,4" })
  }
);
...
var useCheckboxCheck = createHook(
  function useCheckboxCheck2(_a) {
    ...
    const context = (0, import_react32.useContext)(CheckboxCheckedContext);
...
//# sourceMappingURL=chunk-Z2TAJ7P2.js.map
