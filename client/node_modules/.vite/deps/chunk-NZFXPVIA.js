...
function useAutoFocusOnHide(_a) {
  ...
  const [autoFocusOnHide, setAutoFocusOnHide] = (0, import_react.useState)(false);
  ...
  const finalFocusRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
...
var NestedHovercardContext = (0, import_react.createContext)(null);
var useHovercard = createHook(
  function useHovercard2(_a) {
    ...
    const [nestedHovercards, setNestedHovercards] = (0, import_react.useState)([]);
    const hideTimeoutRef = (0, import_react.useRef)(0);
    const enterPointRef = (0, import_react.useRef)(null);
    ...
    const registerOnParent = (0, import_react.useContext)(NestedHovercardContext);
    useSafeLayoutEffect(() => {
      if (modal) return;
      if (!portal) return;
      if (!mounted) return;
    ...
    const registerNestedHovercard = (0, import_react.useCallback)(
      (element) => {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime.jsx)(HovercardScopedContextProvider, { value: store, children: (0, import_jsx_runtime.jsx)(NestedHovercardContext.Provider, { value: registerNestedHovercard, children: element }) }),
...
var useHovercardAnchor = createHook(
  function useHovercardAnchor2(_a) {
    ...
    const showTimeoutRef = (0, import_react2.useRef)(0);
    (0, import_react2.useEffect)(() => () => window.clearTimeout(showTimeoutRef.current), []);
...
var usePopoverArrow = createHook(
  function usePopoverArrow2(_a) {
    ...
    const borderWidth = (0, import_react3.useMemo)(() => {
    ...
    const children = (0, import_react3.useMemo)(
      () => (0, import_jsx_runtime2.jsx)("svg", { display: "block", viewBox: "0 0 30 30", children: (0, import_jsx_runtime2.jsxs)("g", { transform, children: [
        (0, import_jsx_runtime2.jsx)("path", { fill: "none", d: POPOVER_ARROW_PATH, mask: `url(#${maskId})` }),
        (0, import_jsx_runtime2.jsx)("path", { stroke: "none", d: POPOVER_ARROW_PATH }),
        (0, import_jsx_runtime2.jsx)("mask", { id: maskId, maskUnits: "userSpaceOnUse", children: (0, import_jsx_runtime2.jsx)(
          "rect",
          {
            x: "-15",
            y: "0",
...
var MenuItemCheckedContext = (0, import_react4.createContext)(
  void 0
);
...
var useDialogDescription = createHook(function useDialogDescription2(_a) {
  ...
  const setDescriptionId = (0, import_react5.useContext)(DialogDescriptionContext);
...
var useCheckboxContext = ctx3.useContext;
var useCheckboxScopedContext = ctx3.useScopedContext;
var useCheckboxProviderContext = ctx3.useProviderContext;
var CheckboxContextProvider = ctx3.ContextProvider;
var CheckboxScopedContextProvider = ctx3.ScopedContextProvider;
...
var useCheckbox = createHook(
  function useCheckbox2(_a) {
    ...
    store = store || context;
    const [_checked, setChecked] = (0, import_react7.useState)(defaultChecked != null ? defaultChecked : false);
    ...
    const tagName = useTagName(ref, TagName8);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime5.jsx)(CheckboxCheckedContext.Provider, { value: isChecked, children: element }),
      [isChecked]
    );
    props = __spreadProps(__spreadValues({
...
var MenuItemCheckedContext2 = (0, import_react8.createContext)(
  void 0
);
...
function useAriaLabelledBy(_a) {
  var _b = _a, { store } = _b, props = __objRest(_b, ["store"]);
  const [id, setId] = (0, import_react10.useState)(void 0);
...
var useMenuList = createHook(
  function useMenuList2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime6.jsx)(MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var useMenu = createHook(function useMenu2(_a) {
  ...
  props = menuListProps;
  const [initialFocusRef, setInitialFocusRef] = (0, import_react11.useState)();
  ...
  (0, import_react11.useEffect)(() => {
    ...
    setInitialFocusRef((prevInitialFocusRef) => {
      ...
      const ref2 = (0, import_react11.createRef)();
      switch (initialFocus) {
        // TODO: Refactor
        case "first":
  ...
  const preserveTabOrderAnchor = (0, import_react11.useMemo)(() => {
...
//# sourceMappingURL=chunk-NZFXPVIA.js.map
