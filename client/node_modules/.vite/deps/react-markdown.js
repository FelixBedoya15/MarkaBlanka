...
import {
  ...
  thematicBreak,
  toString
} from "./chunk-T4ILJHKN.js";
import {
  decodeNamedCharacterReference
} from "./chunk-PPE3553Y.js";
import {
  codes,
  constants,
  factorySpace,
  ...
  unreachable,
  values
} from "./chunk-CM3AK2LY.js";
import "./chunk-5QM6BV67.js";
import {
  require_jsx_runtime
} from "./chunk-FKSCCI22.js";
import "./chunk-HRQDVIHT.js";
import {
  __commonJS,
  __export,
  __toESM,
...
function point(type) {
  return point6;
  function point6(node) {
    const point7 = node && node.position && node.position[type] || {};
...
// ../node_modules/hast-util-to-jsx-runtime/node_modules/vfile-message/index.js
...
// ../node_modules/hast-util-to-jsx-runtime/node_modules/unist-util-stringify-position/index.js
...
function createChildren(state, node) {
  ...
  while (++index4 < node.children.length) {
    const child = node.children[index4];
    let key;
    if (state.passKeys) {
  ...
  function documentContinue(code2) {
    ...
    if (self2.containerState._closeFlow) {
      ...
      while (index4 < self2.events.length) {
        self2.events[index4][1].end = Object.assign({}, point6);
        index4++;
      }
      splice(
        self2.events,
...
var deserializer = ($, _) => {
  ...
  const unpair = (index4) => {
    ...
    switch (type) {
      ...
      case MAP: {
        const map = as(/* @__PURE__ */ new Map(), index4);
        for (const [key, index5] of value)
          map.set(unpair(key), unpair(index5));
        return map;
      }
      case SET: {
...
// ../node_modules/mdast-util-to-hast/node_modules/unist-util-is/index.js
...
function visitParents(tree, test, visitor, reverse) {
  ...
  factory(tree, void 0, [])();
  function factory(node, index4, parents) {
    const value = (
      /** @type {Record<string, unknown>} */
    ...
    function visit3() {
      ...
      let offset;
      let grandparents;
      if (!test || is3(node, index4, parents[parents.length - 1] || void 0)) {
...
function visit(tree, testOrVisitor, visitorOrReverse, maybeReverse) {
  ...
  function overload(node, parents) {
    ...
    const index4 = parent ? parent.children.indexOf(node) : void 0;
    return visitor(node, index4, parent);
  }
}
...
function trimMarkdownSpaceStart(value) {
  let index4 = 0;
  let code2 = value.charCodeAt(index4);
  while (code2 === 9 || code2 === 32) {
    index4++;
    code2 = value.charCodeAt(index4);
  }
...
// ../node_modules/react-markdown/node_modules/vfile-message/lib/index.js
...
var VFileMessage2 = class extends Error {
  ...
  constructor(causeOrReason, optionsOrParentOrPlace, origin) {
    ...
    this.message = reason;
    this.line = start2 ? start2.line : void 0;
    this.name = stringifyPosition3(options.place) || "1:1";
    this.place = options.place || void 0;
    this.reason = this.message;
    this.ruleId = options.ruleId || void 0;
    this.source = options.source || void 0;
...
function basename(path, extname2) {
  ...
  while (index4--) {
    if (path.codePointAt(index4) === 47) {
      ...
      if (extnameIndex > -1) {
        if (path.codePointAt(index4) === extname2.codePointAt(extnameIndex--)) {
          if (extnameIndex < 0) {
            end = index4;
          }
        } else {
...
function anyFactory2(tests) {
  ...
  let index4 = -1;
  while (++index4 < tests.length) {
    checks[index4] = convert2(tests[index4]);
  }
...
function Markdown(options) {
  ...
  function transform(node, index4, parent) {
    if (node.type === "raw" && parent && typeof index4 === "number") {
      if (skipHtml) {
        parent.children.splice(index4, 1);
      } else {
        parent.children[index4] = { type: "text", value: node.value };
      }
      return index4;
    }
    if (node.type === "element") {
    ...
    if (node.type === "element") {
      ...
      if (!remove && allowElement && typeof index4 === "number") {
        remove = !allowElement(node, index4, parent);
      }
      if (remove && parent && typeof index4 === "number") {
        if (unwrapDisallowed && node.children) {
          parent.children.splice(index4, 1, ...node.children);
        } else {
          parent.children.splice(index4, 1);
        }
        return index4;
