...
var Ge = (r, e, t) => e in r ? Ye(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var I = (r, e, t) => Ge(r, typeof e != "symbol" ? e + "" : e, t);
var ee = (r, e, t) => e.has(r) || de("Cannot " + t);
var E = (r, e, t) => (ee(r, e, "read from private field"), t ? t.call(r) : e.get(r));
var S = (r, e, t) => e.has(r) ? de("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t);
var B = (r, e, t, n) => (ee(r, e, "write to private field"), n ? n.call(r, t) : e.set(r, t), t);
var T = (r, e, t) => (ee(r, e, "access private method"), t);
function Be(r) {
  let e;
  try {
    e = new URL(r);
...
var re = ({
  ...
  (0, import_react.useImperativeHandle)(d == null ? void 0 : d.ref, () => l.current);
  const { error: f, iframeSrc: i, iframeRenderMode: p, htmlString: u } = (0, import_react.useMemo)(
    () => $e(r, n),
    [r, n]
    ...
    return i;
  }, [i, s]), m = (0, import_react.useCallback)(
    (_) => {
      var v;
      if (s) {
  ...
  }, [e]), f) return (0, import_jsx_runtime.jsx)("p", { className: "text-red-500", children: f });
  const h = (0, import_react.useMemo)(() => p === "srcDoc" ? ue(a ?? "", "allow-scripts") : ue(a ?? "", "allow-scripts allow-same-origin"), [a, p]);
  return p === "srcDoc" ? u == null ? f ? null : (0, import_jsx_runtime.jsx)("p", { className: "text-orange-500", children: "No HTML content to display." }) : (0, import_jsx_runtime.jsx)(
    "iframe",
    {
      srcDoc: u,
      sandbox: h,
  ...
  ) : p === "src" ? c == null ? f ? null : (0, import_jsx_runtime.jsx)("p", { className: "text-orange-500", children: "No URL provided for HTML resource." }) : (0, import_jsx_runtime.jsx)(
    "iframe",
    {
      src: c,
      sandbox: h,
...
function it(r, e) {
  ...
  for (const l of t)
    if (l.type === 1 && typeof l.attributes.slot == "string") {
      ...
      d[f] = d[f] ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [d[f], i]
      }) : i;
    } else
      a.push(ne(l, e));
...
var st = Symbol.for("remote-dom.element");
var at = Symbol.for("remote-dom.element.attached");
function lt(r, {
  name: e,
  eventProps: t
} = {}) {
  const n = (0, import_react.memo)(function({
    ...
    const l = (0, import_react.useRef)(), f = ce(o, a), i = f ?? o, p = i.id, u = it(i, {
      receiver: a,
      components: d,
      eventProps: t
    });
    ...
    return l.current.id = p, l.current.receiver = a, (0, import_react.useEffect)(() => {
      var m;
      const c = {
        id: p
      };
    ...
    }, [p, a]), (0, import_jsx_runtime.jsx)(r, {
...
var _e = 4;
var Pe = 5;
var Ee = Symbol.for("quilt.threads.serialize");
var pt = Symbol.for("quilt.threads.transferable");
var mt = class extends AbortController {
  constructor(...e) {
    super();
...
var ft = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
function Ie(r = 21) {
...
z = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakSet(), Oe = function(e) {
...
x = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakSet(), Z = function(e, t, n, s = /* @__PURE__ */ new Map(), o = false) {
  if (e == null) return e;
  if (s.has(e)) return s.get(e);
  if (s.set(e, void 0), typeof e == "object") {
    if (E(this, x) && !o) {
      const l = E(this, x).call(this, e, (f) => T(this, R, Z).call(this, f, t, n, s, true), t, n);
      if (l !== void 0)
        return s.set(e, l), l;
    }
    if (e[pt])
    ...
    if (ve(e) || d) {
      ...
      for (const f of Object.keys(e))
        l[f] = a(e[f]);
      return d && (l.next ?? (l.next = a(e.next.bind(e))), l.return ?? (l.return = a(e.return.bind(e))), l.throw ?? (l.throw = a(e.throw.bind(e))), l[ye] = true), s.set(e, l), l;
    }
  }
  ...
  return s.set(e, e), e;
}, N = function(e, t, n = false) {
  if (e == null) return e;
  if (typeof e == "object") {
    if (E(this, k) && !n) {
      const o = E(this, k).call(this, e, (a) => T(this, R, N).call(this, a, t, true), t);
      if (o !== void 0)
        return o;
    }
    if (e == null)
...
D = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakSet(), oe = async function(e, t, n) {
  try {
...
var Tt = "quilt.threads.ping";
var Te = "quilt.threads.pong";
function gt(r, {
  targetOrigin: e = "*"
} = {}) {
  let t = false;
  const n = function(a, d) {
    ...
    globalThis.window.addEventListener("message", (d) => {
      d.source === r && d.data === Te && (t = true, a.abort(), o());
    }, {
      signal: a.signal
...
var Le = import_react.default.forwardRef(({ content: r, children: e, ...t }, n) => (0, import_jsx_runtime.jsx)("span", { ref: n, ...t, children: r || e }));
Le.displayName = "UIText";
var ze = import_react.default.forwardRef(({ label: r, onPress: e, onClick: t, children: n, ...s }, o) => (0, import_jsx_runtime.jsx)(
  "button",
  {
    ref: o,
    onClick: (d) => {
...
var xe = import_react.default.forwardRef(({ src: r, alt: e, width: t, height: n, children: s, ...o }, a) => (0, import_jsx_runtime.jsx)(
  "img",
  {
    ref: a,
    src: r,
...
var St = ({
  ...
  const s = (0, import_react.useRef)(null), o = (0, import_react.useRef)(null), [a, d] = (0, import_react.useState)(null), l = (0, import_react.useMemo)(() => (r.mimeType || "").includes("framework=react") ? "react" : "webcomponents", [r.mimeType]), f = `${e == null ? void 0 : e.name}-${l}`, { receiver: i, components: p } = (0, import_react.useMemo)(() => {
    switch (l) {
      case "react": {
  ...
  return a ? (0, import_jsx_runtime.jsx)("p", { className: "text-red-500", children: a }) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    l === "react" && p ? (0, import_jsx_runtime.jsx)(dt, { receiver: i, components: p }) : (0, import_jsx_runtime.jsx)(wt, { receiver: i })
  ] });
};
function Mt(r) {
  var e;
...
var Nt = (r) => {
  ...
  switch (a) {
    case "rawHtml": {
      const { proxy: d, ...l } = s || {};
      return (0, import_jsx_runtime.jsx)(re, { resource: e, onUIAction: t, ...l });
    }
    case "externalUrl":
      return (0, import_jsx_runtime.jsx)(re, { resource: e, onUIAction: t, ...s });
    case "remoteDom":
