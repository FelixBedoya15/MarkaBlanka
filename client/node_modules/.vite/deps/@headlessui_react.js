...
import {
  clsx_default
} from "./chunk-UGEWZRV7.js";
import {
  useVirtualizer
} from "./chunk-GUVDCHSL.js";
import {
  flip,
  offset,
  shift,
...
var require_use_sync_external_store_with_selector_production = __commonJS({
  "../node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.production.js"(exports) {
    ...
    var useRef4 = React2.useRef;
    var useEffect5 = React2.useEffect;
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "../node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      var React2 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = React2.useSyncExternalStore, useRef4 = React2.useRef, useEffect5 = React2.useEffect, useMemo2 = React2.useMemo, useDebugValue = React2.useDebugValue;
      exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
        var instRef = useRef4(null);
        if (null === instRef.current) {
          var inst = { hasValue: false, value: null };
...
var D3 = K(function(l16, o21) {
  ...
  let b11 = L();
  return O8 ? !p12 || !n17 ? null : (0, import_react_dom6.createPortal)(b11({ ourProps: { ref: a27 }, theirProps: u24, slot: {}, defaultTag: M2, name: "Portal" }), n17) : null;
});
function J3(e8, l16) {
...
function ho(C13, h11) {
  ...
  let b11 = (0, import_react87.useRef)(false), G6 = o5(() => {
    ...
    switch (e8.actions.setIsTyping(true), t13.key) {
      ...
      case o10.ArrowUp:
        return t13.preventDefault(), t13.stopPropagation(), u(e8.state.comboboxState, { [C8.Open]: () => e8.actions.goToOption({ focus: c9.Previous }), [C8.Closed]: () => {
          (0, import_react_dom7.flushSync)(() => e8.actions.openCombobox()), o21.value || e8.actions.goToOption({ focus: c9.Last });
        } });
      case o10.Home:
    ...
    (s17 = e8.state.buttonElement) != null && s17.contains(B4) || (c18 = e8.state.optionsElement) != null && c18.contains(B4) || o21.disabled || o21.immediate && e8.state.comboboxState !== C8.Open && y11.microTask(() => {
      (0, import_react_dom7.flushSync)(() => e8.actions.openCombobox()), e8.actions.setActivationTrigger(F4.Focus);
    });
...
function Io(C13, h11) {
  ...
  let k9 = o5((r20) => {
    switch (r20.key) {
      case o10.Space:
      case o10.Enter:
        r20.preventDefault(), r20.stopPropagation(), e8.state.comboboxState === C8.Closed && (0, import_react_dom7.flushSync)(() => e8.actions.openCombobox()), S10();
        return;
      case o10.ArrowDown:
        r20.preventDefault(), r20.stopPropagation(), e8.state.comboboxState === C8.Closed && ((0, import_react_dom7.flushSync)(() => e8.actions.openCombobox()), e8.state.dataRef.current.value || e8.actions.goToOption({ focus: c9.First })), S10();
        return;
      case o10.ArrowUp:
        r20.preventDefault(), r20.stopPropagation(), e8.state.comboboxState === C8.Closed && ((0, import_react_dom7.flushSync)(() => e8.actions.openCombobox()), e8.state.dataRef.current.value || e8.actions.goToOption({ focus: c9.Last })), S10();
        return;
      case o10.Escape:
        if (e8.state.comboboxState !== C8.Open) return;
        r20.preventDefault(), e8.state.optionsElement && !o21.optionsPropsRef.current.static && r20.stopPropagation(), (0, import_react_dom7.flushSync)(() => e8.actions.closeCombobox()), S10();
        return;
      default:
        return;
    }
...
function ht(g8, D8) {
  ...
  let v6 = o5((r20) => {
    ...
    if (r20.button === 0) {
      ...
      p12.state.listboxState === E13.Open ? ((0, import_react_dom8.flushSync)(() => p12.actions.closeListbox()), (B4 = p12.state.buttonElement) == null || B4.focus({ preventScroll: true })) : (r20.preventDefault(), p12.actions.openListbox({ focus: c9.Nothing }));
    }
  ...
  let h11 = o5((e8) => {
    ...
    switch (Z4.dispose(), e8.key) {
      ...
      case o10.Enter:
        ...
        a27.mode === L6.Single && ((0, import_react_dom8.flushSync)(() => t13.actions.closeListbox()), (S10 = t13.state.buttonElement) == null || S10.focus({ preventScroll: true }));
        break;
      ...
      case o10.Escape:
        e8.preventDefault(), e8.stopPropagation(), (0, import_react_dom8.flushSync)(() => t13.actions.closeListbox()), (X4 = t13.state.buttonElement) == null || X4.focus({ preventScroll: true });
        return;
      case o10.Tab:
        e8.preventDefault(), e8.stopPropagation(), (0, import_react_dom8.flushSync)(() => t13.actions.closeListbox()), j5(t13.state.buttonElement, e8.shiftKey ? T5.Previous : T5.Next);
        break;
      default:
...
function _t(g8, D8) {
  ...
  let U6 = o5((n17) => {
    ...
    o21.actions.onChange(p12), b11.mode === L6.Single && ((0, import_react_dom8.flushSync)(() => o21.actions.closeListbox()), (L8 = o21.state.buttonElement) == null || L8.focus({ preventScroll: true }));
  }), w12 = o5(() => {
...
function nt(c18, E17) {
  ...
  let u24 = o5((e8) => {
    ...
    if (e8.button === 0) {
      ...
      l16 || (M9 === E14.Open ? ((0, import_react_dom9.flushSync)(() => p12.send({ type: F11.CloseMenu })), (R5 = y11.current) == null || R5.focus({ preventScroll: true })) : (e8.preventDefault(), p12.send({ type: F11.OpenMenu, focus: { focus: c9.Nothing }, trigger: O7.Pointer })));
    }
...
function st(c18, E17) {
  ...
  let z4 = p(), pe5 = o5((t13) => {
    ...
    switch (z4.dispose(), t13.key) {
      ...
      case o10.Escape:
        t13.preventDefault(), t13.stopPropagation(), (0, import_react_dom9.flushSync)(() => o21.send({ type: F11.CloseMenu })), (Z4 = o21.state.buttonElement) == null || Z4.focus({ preventScroll: true });
        break;
      case o10.Tab:
        t13.preventDefault(), t13.stopPropagation(), (0, import_react_dom9.flushSync)(() => o21.send({ type: F11.CloseMenu })), j5(o21.state.buttonElement, t13.shiftKey ? T5.Previous : T5.Next);
        break;
      default:
