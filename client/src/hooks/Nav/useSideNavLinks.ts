...
import { Database, Bookmark, Settings2, ArrowRightToLine, MessageSquareQuote, FileCog } from 'lucide-react';
import {
  Permissions,
  EModelEndpoint,
  PermissionTypes,
...
export default function useSideNavLinks({
  ...
  const Links = useMemo(() => {
    ...
    links.push({
      title: 'Configurar Exportación' as any,
      label: '',
      icon: FileCog,
      id: 'export-config',
      Component: ExportConfigPanel,
    });
