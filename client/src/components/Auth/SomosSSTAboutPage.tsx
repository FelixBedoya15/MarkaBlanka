...
/* ─── Main Page ────────────────────────────────────────────────────── */
export default function SomosSSTAboutPage() {
        ...
        <div className="min-h-screen bg-surface-secondary relative">
            ...
            <div className="mx-auto max-w-4xl px-6 py-12">
                ...
                <Section icon={<HistorySVG />} title="Nuestra Historia">
                    <p>
                        <strong>SomosSST S.A.S.</strong> nació en la ciudad de <strong>Medellín, Colombia</strong>,
                    ...
                    <p>
                        Hoy, nuestra plataforma <strong>SomosSST</strong> integra modelos avanzados de
